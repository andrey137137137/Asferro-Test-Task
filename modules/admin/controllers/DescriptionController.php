 ...
 */
class DescriptionController extends DependentController
{
  /**
   * {@inheritdoc}
   */
  ...
  public function actionCreate()
  {
    ...
    return $this->render('create', [
      'model' => $model,
      'jobDropDownList' => $this->getDropDownList('company', 'id')
    ]);
  }
  ...
  {
    return Job::find()->select(['id', 'company'])->orderBy('company')->asArray()->all();
  }
}
